...
using ASP.NET_Core_Identity.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            if (model.Name != name || model.Surname != surname)
            {
                ...
                {
                    throw new ApplicationException($"Unexpected error occurred setting name or surname for user with ID '{user.Id}'.");
                }
            }
